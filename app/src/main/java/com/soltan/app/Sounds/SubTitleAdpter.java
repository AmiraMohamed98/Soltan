...
public class SubTitleAdpter extends RecyclerView.Adapter<SubTitleAdpter.ViewHolder> {
    String title;
    Context context;
    List<String> list;
   ...
   public SubTitleAdpter(List<String> list, Context context, String title, FragmentManager fragmentManager){
     this.list=list;
     this.context=context;
     this.title=title;
     this.fragmentManager=fragmentManager;
   }
    public SubTitleAdpter(ArrayList<String> list,Map<String, String> cat, Context context, String title, FragmentManager fragmentManager){
        this.list=list;
        this.context=context;
        this.title=title;
        this.fragmentManager=fragmentManager;
...
//            ft.commit();
            ...
            Bundle args = new Bundle();
            args.putString("title",title);
            args.putString("sub",list.get(position));
