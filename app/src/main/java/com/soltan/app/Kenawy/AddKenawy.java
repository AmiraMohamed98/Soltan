...
public class AddKenawy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_kenawy);
        parameters= getIntent().getExtras();
        type=parameters.getString("listName");
...
//
        ...
        findViewById(R.id.btn_add_Audio).setOnClickListener(
...
//                });
    ...
    private void uploadPdf(Uri sUri) {
        ...
        progressDialog.show();
        storageRef.child("فتاوى"+"/"+type).child(name).putFile(sUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            @Override
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
//                Task<Uri> uri=taskSnapshot.getStorage().getDownloadUrl();
//                while (!uri.isComplete());
//                Uri url=uri.getResult();
                Toast.makeText(AddKenawy.this, "تم إضافه الملف", Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
//                Map<String,Object> map=new HashMap<>();
//                map.put("Name",name);
//                map.put("url",url.toString());
//                db.collection("Fatwa").document(type)
//                        .collection("0")
...
//                                Toast.makeText(AddKenawy.this, "لم يتم إضافه الملف"+e.getMessage(), Toast.LENGTH_SHORT).show();
//                              //  Log.d("tag","failled"+e.getMessage());
//                                progressDialog.dismiss();
//                            }
//                        });
            }
            ...
            @Override
            public void onFailure(@androidx.annotation.NonNull Exception e) {
               // Log.d("tag","failled2"+e.getMessage());
                Toast.makeText(AddKenawy.this, "لم يتم إضافه الملف"+e.getMessage(), Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
            }
        });
